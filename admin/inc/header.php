...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_url ?>/admin/assets/css/lib/datatable/dataTables.bootstrap.min.css">
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    ?>
                        <li class="<?= $title == 'Admin Users' ? 'active' : '' ?>">
                            <a href="<?= $base_url ?>/admin/admin_users.php">
                                <i class="menu-icon fa fa-users-gear"></i>
                                Admin Users</a>
                        </li>
                    <?php
                    ...
                    <li class="<?= $title == 'All Users' ? 'active' : '' ?>">
                        <a href="<?= $base_url ?>/admin/user-list.php">
                            <i class="menu-icon fa fa-users"></i>General Users</a>
                    </li>

                    <li class="menu-title">Product Management</li><!-- /.menu-title -->
                    <li class="<?= $title == 'Categories' ? 'active' : '' ?>">
                        <a href="<?= $base_url ?>/admin/categories/"> <i class="menu-icon fa fa-tags"></i>Categories </a>
                    </li>
                    <li class="<?= $title == 'Brands' ? 'active' : '' ?>">
                        <a href="<?= $base_url ?>/admin/brands/"> <i class="menu-icon fa fa-crown"></i>Brands</a>
                    </li>
                    <li class="<?= $title == 'Products' ? 'active' : '' ?>">
                        <a href="<?= $base_url ?>/admin/products/"> <i class="menu-icon fa fa-box-open"></i>Products </a>
                    </li>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="<?= $base_url ?>/admin/images/admin.jpg" alt="User Avatar">
                        </a>
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="<?= $base_url ?>/admin/logout.php"><i class="fa fa-power -off"></i>Logout</a>
                        </div>
                    </div>
