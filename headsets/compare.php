    ...
    <div class="container-lg mb-1" style="border: 1px solid #dee2e6;">
        <div class="pdcm-box">
            <div class="cmpr-spec-qlink hide-mobile">
                <div class="jump-specs whitebg padd10">
                    <ul class="list-unstyled">
                        ...
                        <a class="greycolor font13 fontbold" href="#Sound">
            ...
            <div class="cmpr-spec-box">
                ...
                <div>
                    ...
                    <table class="cmpr-spec-tbl">
                        <tbody>
                            ...
                            <tr>
                                <td class="spec-head">Connectivity</td>
                                <?php if (isset($products)): ?>
                                    <?php foreach ($products as $product): ?>
                            ...
                            <tr>
                                <td class="spec-head">Box Contents</td>
                                <?php if (isset($products)): ?>
                                    <?php foreach ($products as $product): ?>
                                        <td><?php echo $product['in_the_box']; ?></td>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tr>
                        </tbody>
                ...
                <div>
                    <div style="scroll-margin-top:9.5em;" id="Sound" class="text-center pl5 pr5 grey-bg pt10 pb5">
                        <h3 class="blackcolor">Sound Features</h3>
                    </div>
                    <table class="cmpr-spec-tbl">
                        <tbody>
                            <tr>
                                <td class="spec-head">Driver Unit</td>
                                <?php if (isset($products)): ?>
                                    <?php foreach ($products as $product): ?>
                                        <td><?php echo $product['driver']; ?></td>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tr>
                            <tr>
                                <td class="spec-head">Frequency Response</td>
                                <?php if (isset($products)): ?>
                                    <?php foreach ($products as $product): ?>
                                        <td><?php echo $product['frequency_response']; ?></td>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tr>
                        </tbody>
                ...
                <div>
                    <div style="scroll-margin-top:9.5em;" id="Features" class="text-center pl5 pr5 grey-bg pt10 pb5">
                        <h3 class="blackcolor">General Features</h3>
                    </div>
                    <table class="cmpr-spec-tbl">
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <td class="spec-head">Controls</td>
                                <?php if (isset($products)): ?>
                                    <?php foreach ($products as $product): ?>
                                        <td><?php echo $product['controls']; ?></td>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tr>
                            <tr>
                                <td class="spec-head">Control Features</td>
                                <?php if (isset($products)): ?>
                                    <?php foreach ($products as $product): ?>
                                        <td><?php echo $product['control_features']; ?></td>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tr>
                            <tr>
                                <td class="spec-head">Buit-in Mic</td>
                                <?php if (isset($products)): ?>
                                    <?php foreach ($products as $product): ?>
                                        <td><?php echo $product['built-in_mic'] ? 'Yes' : 'No'; ?></td>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tr>
                            <tr>
                                <td class="spec-head">Water Resistant</td>
                                <?php if (isset($products)): ?>
                                    <?php foreach ($products as $product): ?>
                                        <td><?php echo $product['water_resistant'] ? 'Yes' : 'No'; ?></td>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tr>
                            <tr>
                                <td class="spec-head">Additional Features</td>
                                <?php if (isset($products)): ?>
                                    <?php foreach ($products as $product): ?>
                ...
                <div>
                    <div style="scroll-margin-top:9.5em;" id="Battery" class="text-center pl5 pr5 grey-bg pt10 pb5">
                        <h3 class="blackcolor">Battery &amp; Charging</h3>
                    </div>
                    <table class="cmpr-spec-tbl">
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <td class="spec-head">Charging Port</td>
                                <?php if (isset($products)): ?>
                                    <?php foreach ($products as $product): ?>
                                        <td><?php echo $product['charging_port']; ?></td>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tr>
                            <tr>
                                <td class="spec-head">Charging Time</td>
                                <?php if (isset($products)): ?>
                                    <?php foreach ($products as $product): ?>
                                        <td><?php echo $product['charging_time']; ?></td>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tr>
                        </tbody>
