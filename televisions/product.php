        ...
        <nav class="p-2 pb-0" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="../televisions/?brand=<?= $row['brand_name'] ?>"><?= $row['brand_name'] ?></a></li>
            ...
            <div class="col-md-8 my-2">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <span style="padding-left: 37px;"
                                class="key-spec-value"><?= $row['smart_tv'] ? 'Yes' : 'No'; ?></span>
                        </div>
                        <div class="row pt-md-2 ">
                            <div class="d-flex align-items-center ">
                        ...
                        <div class="row">
                            <span style="padding-left: 37px;"
                                class="key-spec-value"><?= $row['display_features']; ?></span>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <span style="padding-left: 37px;" class="key-spec-value"><?= $row['screen_size']; ?>
                                Display</span>
                        </div>
                        <div class="row pt-md-2 ">
                            <div class="d-flex align-items-center ">
                        ...
                        <div class="row">
                            <span style="padding-left: 37px;"
                                class="key-spec-value"><?= $row['preloaded_apps']; ?></span>
                        </div>
                        <div class="row pt-md-2 ">
                            <div class="d-flex align-items-center ">
                                ...
                                <span style="padding-left: 7px;" class="key-spec-name fw-bold">OS (Operating
                                    System)</span>
                            </div>
                        </div>
                        <div class="row">
